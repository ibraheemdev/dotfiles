...
cmd('command! PaqInstall  lua require("paq").install()')
cmd('command! PaqUpdate   lua require("paq").update()')
cmd('command! PaqClean    lua require("paq").clean()')
cmd('command! PaqLogOpen  lua require("paq").log_open()')
cmd('command! PaqLogClean lua require("paq").log_clean()')
